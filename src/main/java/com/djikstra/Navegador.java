 ...
 * Esta classe é uma versão adaptada da sua, utilizando a nova estrutura de dados.
 */
public class Navegador {
    ...
    public static Resultado calcularRota(Grafo grafo, Cidade inicio, Cidade destino) {
        ...
        // PriorityQueue é mais eficiente para Dijkstra do que verificar a lista toda a cada iteração
        ...
        // Se o destino não foi alcançado, seu predecessor será null (e ele não é o início)
