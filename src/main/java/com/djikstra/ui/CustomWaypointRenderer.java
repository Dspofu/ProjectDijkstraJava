...
import org.jxmapviewer.viewer.WaypointPainter; // Apenas para referência do Javadoc se necessário

import javax.swing.*;
import java.awt.*;

/**
 * Renderer customizado para desenhar nossos CustomWaypoint (que contêm um botão)
